...
Revision ID: 7e6080593f5d
Revises: 
Create Date: 2024-06-05 20:53:11.946709
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['post_id'], ['posts.id'], name=op.f('bookmarks_post_id_fkey'), ondelete='CASCADE'),
    ...
    sa.UniqueConstraint('user_id', 'post_id', name='unique_bookmark_for_user_post_relations')
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['post_id'], ['posts.id'], name=op.f('views_post_id_fkey'), ondelete='CASCADE'),
